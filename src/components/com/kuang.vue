<template>
    <div id="kz" style="display: flex">
        <div v-for="index of 5" class="main" :key="index.id" :gindex="index">
            <div>
                <img src="../../assets/hb28.png" alt="" />
            </div>
            <div style="display: flex; margin-left: 35px; margin-top: -5px">
                <div
                    class="t1"
                    v-for="index of 6"
                    :key="index.id"
        ...
        handlePeople(e) {
            ...
            if (!this.pName) {
                ...
                e.currentTarget.parentElement.className =
                    e.currentTarget.parentElement.className + " choose";
                    ...
                    if (i == this.lastSeat[j]) {
                        if (this.persons[j].merge == 0) {
                            if (this.persons[j]["userUnit"] != null) {
                                ...
                                oSpan[i].innerText = this.persons[j]["userUnit"].des;
                            }
                        } else {
                            oT1[i].innerText = "占位";
                        }
...
.choose {
    ...
    text-align: center;
    color: #fff;
    background-image: url("../../assets/画板 34.png");
    background-size: 100% 100%;
    background-repeat: no-repeat;
}
.zhanyong {
    ...
    text-align: center;
    color: #fff;
    background-image: url("../../assets/画板 35.png");
    background-size: 100% 100%;
    background-repeat: no-repeat;
}
.main {
